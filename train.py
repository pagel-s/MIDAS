...
if __name__ == "__main__":
    ...
    # Optional text model name for conditioning
    p.add_argument('--text_model_name', type=str, default=None)
    # Optional CSV with columns: name,text
    p.add_argument('--text_csv', type=str, default=None)
    # Optional precomputed text embeddings
    p.add_argument('--text_embeddings_path', type=str, default=None)
    args = p.parse_args()
    ...
    #     resume_config = checkpoint_['hyper_parameters']
    ...
    print("histogram_file", histogram_file)
